...
namespace SpellEditor.Sources.VersionControl
{
    class WoWVersionManager
    {
        ...
        private WoWVersion _CurrentVersion = new WoWVersion() { Name = "WoW 1.12.1", Version = "1.12.1", NumLocales = 8 };
        // new WoWVersion() { Name = "WoW 3.3.5a, Version = "3.3.5a 12340", NumLocales = 16 };
