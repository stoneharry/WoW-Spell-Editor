...
{
    class SpellShapeshiftForm : AbstractDBC, IBoxContentProvider
    {
        public List<DBCBoxContainer> Lookups = new List<DBCBoxContainer>();

        public SpellShapeshiftForm()
        {
            ReadDBCFile(Config.Config.DbcDirectory + "\\SpellShapeshiftForm.dbc");
        }
        ...
        public int UpdateSpellShapeshiftFormSelection(uint ID)
        {
